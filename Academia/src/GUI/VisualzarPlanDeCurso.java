 ...
 * @author Juuan
 */
public class VisualzarPlanDeCurso extends javax.swing.JFrame {

    /**
     * Creates new form VisualzarPlanDeCurso
     */
    public VisualzarPlanDeCurso() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisualzarPlanDeCurso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisualzarPlanDeCurso().setVisible(true);
            }
        });
    }
